    ...
    getIdCardInfo() {
      ...
      ReadCarId(30000, (data) => {
        if (Number(data.resultcode) == 200) {
          var data = data.data;
          this.addOrderOptions.name = data.Name;
          this.addInRoomList[0].mainPersonInfo.name = data.Name;
          this.addOrderOptions.idcard = data.Id;
          this.addInRoomList[0].mainPersonInfo.idcard = data.Id;
          clearInterval(this.cancelTimer);
          this.cancelTime = 30;
          this.showCancelTime = false;
          CancelRead();
